...
exports.jwtService = {
    ...
    createJWTRefreshToken(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const refreshToken = jsonwebtoken_1.default.sign({ userId: user._id }, settings_1.settings.JWT_ACCESS_SECRET, { expiresIn: "20s" });
            const dbToken = {
                userId: user._id,
                token: refreshToken
            };
    ...
    createNewJWTRefreshToken(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const newRefreshToken = jsonwebtoken_1.default.sign({ userId: user._id }, settings_1.settings.JWT_ACCESS_SECRET, { expiresIn: "20s" });
            const newDbToken = {
                userId: user._id,
